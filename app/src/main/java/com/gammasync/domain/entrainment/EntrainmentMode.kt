...
/**
 * Available entrainment modes in the Universal Modulation Platform.
 *
 * @param displayName User-facing name for the mode
 * @param description Brief description of the entrainment purpose
...
enum class EntrainmentMode(
     ...
     */
    FOCUS_RELIEF(
        displayName = "Focus Relief",
        description = "Static green for enhanced focus"
    ),
