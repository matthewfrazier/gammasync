...
/**
 * Available experience modes in the Universal Modulation Platform.
 *
 * @param displayName User-facing name for the mode
 * @param description Brief description of the experience purpose
...
enum class ExperienceMode(
    ...
    /**
     * Migraine Relief: Static green light stimulation.
